...
describe('LoginComponent', () => {
  ...
  it('should call login method on submit when form is valid', () => {
    authService.login.mockReturnValue(of({} as SessionInformation)); // Mock the login method with a return value
  ...
  it('should show error message on login failure', () => {
    authService.login.mockReturnValue(throwError({ error: 'An error occurred' })); // Mock the login method to return an error
    component.form.setValue({
